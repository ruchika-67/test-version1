...
if __name__=="__main__":
    ...
    ax.set_ylabel(r"$f \sigma_8(z)$ ", fontsize=22)
    plt.xlim(zmin, 0.60)
    ...
    plt.legend((r"$f \sigma_8(z)$ rec ($1\sigma$)", "$f \sigma_8(z)$ rec ($2\sigma$)", "$f \sigma_8(z)$ rec ($3\sigma$)", "$f \sigma_8(z)$ data"), fontsize='22', loc='upper left')
    plt.savefig('fs8.pdf', bbox_inches='tight')
    plt.show()
    # =========== saving the plot
